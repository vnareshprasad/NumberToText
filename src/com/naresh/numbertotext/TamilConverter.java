...
public class TamilConverter extends NumberToWordConverter{
	...
	static TamilStrings tamilStrings = new TamilStrings();
	...
	static public enum Scale {
        ...
        public String getName(int exponent) {
            for (ScaleUnit unit : tamilStrings.SCALE_UNITS) {
    ...
    static public class UnitProcessor extends AbstractProcessor {
        ...
        public String getName(String value) {
            ...
            if (offset != NO_VALUE && offset < tamilStrings.NUM_NAMES.length) {
                buffer.append(tamilStrings.NUM_NAMES[offset]);
            }
    ...
    static public class TensProcessor extends AbstractProcessor {
        ...
        public String getName(String value) {
            ...
            if (number >= 20) {
                buffer.append(tamilStrings.TENS_NAMES[(number / 10) - 2]);
                number %= 10;
                tensFound = true;
            } else {
                number %= 20;
    ...
    static public class HundredProcessor extends AbstractProcessor {
        ...
        public String getName(String value) {
            ...
            if (number >= 100) {
            	...
            	buffer.append(tamilStrings.HUNDRED_NAMES[number / 100 - 1]);
    ...
    static public class DefaultProcessor extends AbstractProcessor {
        ...
        static private String MINUS = "எதிர்மறை";
        static private String UNION_AND = "மற்றும்";

        static private String ZERO_TOKEN = "பூஜ்யம்";
