...
import com.naresh.numbertotext.EnglishStrings;

public class EnglishConverter extends NumberToWordConverter{
	...
	static public enum Scale {
        ...
        EnglishStrings englishStrings = new EnglishStrings();
        
        public String getName(int exponent) {
            for (ScaleUnit unit : englishStrings.SCALE_UNITS) {
